...
public class BannerAdminController {
    ...
    @ApiResponses(value = {
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "잘못된 요청 (필수 필드 누락 등)", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<Banner>> createBanner(@RequestBody BannerAdminRequestDto requestDto) {
    ...
    @PutMapping("/{bannerId}")
    public ResponseEntity<ApiResponse<Banner>> updateBanner(@PathVariable Long bannerId, @RequestBody BannerAdminRequestDto requestDto) {
