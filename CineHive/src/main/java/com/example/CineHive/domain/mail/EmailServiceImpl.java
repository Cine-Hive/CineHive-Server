<<<<<<< HEAD:CineHive/src/main/java/com/example/CineHive/domain/mail/service/EmailServiceImpl.java
package com.example.CineHive.domain.mail.service;
=======
package com.example.CineHive.domain.mail;
>>>>>>> parent of 49bd7c6b ([Ref]: 도메인 패키지 구조 정리):CineHive/src/main/java/com/example/CineHive/domain/mail/EmailServiceImpl.java
