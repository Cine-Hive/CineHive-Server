<<<<<<< HEAD:CineHive/src/main/java/com/example/CineHive/domain/admin/repository/AdminAppearanceRepository.java
package com.example.CineHive.domain.admin.repository;

import com.example.CineHive.domain.admin.entity.HomeChartSetting;
=======
package com.example.CineHive.domain.admin;
>>>>>>> parent of 49bd7c6b ([Ref]: 도메인 패키지 구조 정리):CineHive/src/main/java/com/example/CineHive/domain/admin/AdminAppearanceRepository.java
