 ...
 */
@Repository
public interface DislikeRepository extends JpaRepository<PostLike, Long> {
     ...
     */
    Optional<PostLike> findByMemberAndBoard(User user, Post post);
     ...
     */
    @Modifying
    @Query("DELETE FROM PostLike d WHERE d.member.email = :email")
