...
/*
1. 라인  40 ~64번째 줄은 HEADER, PAYLOAD, SIGNATURE를 생성하고 인코딩하는 부분
...
2. createToken 함수의 .signWith(SECRET_KEY)에서 SIGNATURE를 생성한다. 이 부분에서 비밀 키를 사용하여 HMAC_SHA256 알고리즘으로 해싱한다.
3. createToken 함수에서 compact에서 HEADER, PAYLOAD, SIGNATURE를 점(.)으로 연결하여 최종 JWT 토큰을 생성
