<<<<<<< HEAD:CineHive/src/main/java/com/example/CineHive/domain/account/controller/AccountController.java
package com.example.CineHive.domain.account.controller;
=======
package com.example.CineHive.domain.account;
>>>>>>> parent of 49bd7c6b ([Ref]: 도메인 패키지 구조 정리):CineHive/src/main/java/com/example/CineHive/domain/account/AccountController.java
