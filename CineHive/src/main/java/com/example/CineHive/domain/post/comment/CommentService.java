<<<<<<< HEAD:CineHive/src/main/java/com/example/CineHive/domain/post/comment/service/CommentService.java
package com.example.CineHive.domain.post.comment.service;
=======
package com.example.CineHive.domain.post.comment;
>>>>>>> parent of 49bd7c6b ([Ref]: 도메인 패키지 구조 정리):CineHive/src/main/java/com/example/CineHive/domain/post/comment/CommentService.java
...
public interface CommentService {
     ...
     */
    com.example.CineHive.domain.common.controller.dto.PageResponse<CommentResponse> getCommentsByPost(Long postId, int page, int size);
