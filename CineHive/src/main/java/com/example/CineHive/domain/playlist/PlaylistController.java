<<<<<<< HEAD:CineHive/src/main/java/com/example/CineHive/domain/playlist/controller/PlaylistController.java
package com.example.CineHive.domain.playlist.controller;
=======
package com.example.CineHive.domain.playlist;
>>>>>>> parent of 49bd7c6b ([Ref]: 도메인 패키지 구조 정리):CineHive/src/main/java/com/example/CineHive/domain/playlist/PlaylistController.java
