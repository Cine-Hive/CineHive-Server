<<<<<<< HEAD:CineHive/src/main/java/com/example/CineHive/domain/post/comment/controller/CommentController.java
package com.example.CineHive.domain.post.comment.controller;
=======
package com.example.CineHive.domain.post.comment;
>>>>>>> parent of 49bd7c6b ([Ref]: 도메인 패키지 구조 정리):CineHive/src/main/java/com/example/CineHive/domain/post/comment/CommentController.java
