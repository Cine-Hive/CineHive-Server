...
public interface OAuth2Service {
     ...
     */
    LoginResponseDto loginWithCode(ProviderType providerType, String code);
     ...
     * @return 로그인 성공 시 JWT 토큰과 회원 정보를 담은 DTO
     */
    LoginResponseDto loginWithAccessToken(ProviderType providerType, String accessToken);
