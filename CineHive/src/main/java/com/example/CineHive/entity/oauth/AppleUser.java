...
public class AppleUser {
    ...
    @ElementCollection
    @CollectionTable(name = "apple_user_genres", joinColumns = @JoinColumn(name = "apple_user_id"))
    @Column(name = "genre")
    private List<String> genres;


    public AppleUser(String nickname, String memEmail, String name, List<String> genres) {
