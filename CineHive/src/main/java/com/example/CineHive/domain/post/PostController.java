<<<<<<< HEAD:CineHive/src/main/java/com/example/CineHive/domain/post/controller/PostController.java
package com.example.CineHive.domain.post.controller;
=======
package com.example.CineHive.domain.post;
>>>>>>> parent of 49bd7c6b ([Ref]: 도메인 패키지 구조 정리):CineHive/src/main/java/com/example/CineHive/domain/post/PostController.java
