<<<<<<< HEAD:CineHive/src/main/java/com/example/CineHive/domain/report/entity/ReportStatus.java
package com.example.CineHive.domain.report.entity;
=======
package com.example.CineHive.domain.report;
>>>>>>> parent of 49bd7c6b ([Ref]: 도메인 패키지 구조 정리):CineHive/src/main/java/com/example/CineHive/domain/report/ReportStatus.java
